...
public class BrewRecipeParser extends BaseRecipeParser {
    ...
    public boolean parseRecipe(int directiveLine) throws Exception {
        ...
        ItemStack ingredient = Tools.parseItem(reader.getLine(), Vanilla.DATA_WILDCARD, ParseBit.NO_AMOUNT | ParseBit.NO_META);
        if (ingredient == null) {
        ...
        ItemStack potion = Tools.parseItem(reader.getLine(), Vanilla.DATA_WILDCARD, ParseBit.NO_AMOUNT | ParseBit.NO_META);
        if (potion == null) {
